  ...
  return (
    <>
      <div>
        ...
        <div
          className="bg-orange-400 absolute top-0  h-20"
          style={{ left: 250 }}
        >
          ...
          <Wrapper className="section-center px-28 w-86">
            <article className="content">
              ...
              Virtual School offers flexible, high-quality online learning with experienced teachers and interactive tools. Personalized education for students of all ages, for supplement or full-time education.
              </p>
