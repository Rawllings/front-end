      ...
      <div className="flex flex-row border-b border-gray-200 py-2">
        ...
        <div className="w-3/12 px-4">
          ...
          >
            ...
            <option value="present" className="text-green-500 font-bold">
              Present
            </option>
            <option value="absent" className="text-red-500 font-bold">
              Absent
            </option>
          </select>
          <button
            className="bg-blue-500 text-white py-2 px-4 ml-4 rounded-md"
            onClick={handleClick}
          >
            Edit Status
          </button>
